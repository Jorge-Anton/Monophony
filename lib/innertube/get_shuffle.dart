...
Future<List<SongModel>?> getShuffle(String songId, String playlistId, String params) async {
  final headers = {
  ...
  final body = '''{"context":{"client":{"clientName":"WEB_REMIX","clientVersion":"1.20220918","platform":"DESKTOP","hl":"en","visitorData":"CgtEUlRINDFjdm1YayjX1pSaBg%3D%3D"}},"videoId":"$songId","isAudioOnly":true,"playlistId":"$playlistId","tunerSettingValue":"AUTOMIX_SETTING_NORMAL","params":"$params","watchEndpointMusicSupportedConfigs":{"musicVideoType":"MUSIC_VIDEO_TYPE_ATV"}}''';
  ...
  if (response.statusCode == 200) {
    final decodedBr = brotli.decodeToString(response.bodyBytes, encoding: const Utf8Codec());
